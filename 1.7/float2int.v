...
module  float2int_altbarrel_shift_mof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //float2int_altbarrel_shift_mof

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 217 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  float2int_altfp_convert_bqm
	( 
	clock,
	dataa,
	result) ;
	...
	float2int_altbarrel_shift_mof   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //float2int_altfp_convert_bqm
//VALID FILE
...
module float2int (
	...
	float2int_altfp_convert_bqm	float2int_altfp_convert_bqm_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
