...
void main() {
    ...
    // TODO: state INIT - display the welcome screen
    ...
    // TODO: state PLAYER_WIN - player has won

    // TODO: state DEALER_WIN - dealer has won

    // TODO: state TIE - tie

    // TODO: state SEND_RESULT - allows user to send result to phone, return to the welcome screen, or start again
